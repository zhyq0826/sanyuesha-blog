---
title: "理解 Go interface 的 5 个关键点"
summary: "## 1、interface 是一种类型"
date: "2017-07-22"
tags: 
  - "interface"
group: "golang"
...
详解 Go interface 系列
- [go-interface-1](/posts/go-interface-1)
- [go-interface-2](/posts/go-interface-2)
- [go-interface-3](/posts/go-interface-3)
- [go-interface-4](/posts/go-interface-4)