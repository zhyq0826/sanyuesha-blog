---
title: "用 markdown 自定义排版公众号文章"
summary: "可能吧的阿禅的之前写了一篇文章介绍了他是如何排版公众号文章的：思路就是用 markdown 写作，然后使用专门的工具导出为 html 文件，最后把自定义的样式应用到导出的文件，复制粘贴最终的内容到微信公众号。"
date: "2016-11-18"
tags: 
  - "微信公众号"
group: "程序人生"
...
>
> [markdown-css](http://wecatch.me/markdown-css/)
